...
export const enrichCompanyData = async (linkedinUrl) => {
  ...
  try {
    ...
    const prompt = `Extract the following information only from the LinkedIn company page and return it as a JSON object. If a field is not found, leave it as an empty string:

- company_name: The company name
- location: Company headquarters location
- industry: Company industry
- number_of_employees: Number of employees in format like "11-50", "51-200", "1000+" etc.
...
Expected JSON format:
{
  ...
  Get public data, this is available.`
;
